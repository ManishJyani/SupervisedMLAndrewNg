...
y= wx + b
Need to predict y , which according to this model depends upto x with some weigh and bias (b), need to find out w, and b, but how 
...
2. How would we get know where to stop, if mean how would I be sure , this cost function is minimum.
